...
def _get_config(params, arg_name, subfolder):
    ...
    if config_name is not None:
        with open(os.path.join(os.path.dirname(__file__), "config", subfolder, "{}.yaml".format(config_name)), "r", encoding='gb18030', errors='ignore') as f:
...
if __name__ == '__main__':
    ...
    params.append("--env-config=hallway_group")
