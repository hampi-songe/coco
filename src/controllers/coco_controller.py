...
class BasicMAC:
    ...
    def forward(self, ep_batch, t, test_mode=False):
        ...
        with th.no_grad():
            if self.args.input == 'hidden':
                ...
                latent_state = self.consensus_builder.calc_student(agent_inputs)# [bs * n_agents, CB_dim]
            ...
            #print(latent_state_embedding.shape)

        # 计算Q值
        agent_outs, dis, inf_dis, personal_msg = self.agent.calc_value(ep_batch.batch_size, latent_state_embedding, self.hidden_states, test_mode=test_mode)
        # z = dis.sample()
        ...
        if self.agent_output_type == "pi_logits":
            ...
            agent_outs = th.nn.functional.softmax(agent_outs, dim=-1)# [bs * n_agents, n_actions]
    ...
    def inf_parameters(self):
        return self.agent.inference_net.parameters()
